...
It includes setup steps, scripts to run, and measured results for FAISS and Milvus Lite.
...
\begin{itemize}[leftmargin=*]
  ...
  \item In this specific run, Milvus recall and QPS were nearly invariant across \texttt{nprobe}.
        This should be rechecked with an additional parameter sweep and index verification.
\end{itemize}
...
\begin{itemize}[leftmargin=*]
  ...
  \item Add Milvus standalone server run (beyond Lite) for closer production parity.
\end{itemize}
