...
%----- QPS plot FLAT -----
\begin{frame}{QPS --- IVF\_FLAT (AMD ahead)}
  \vspace{-0.2em}
...
\begin{frame}{One picture --- do not blend the two}
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[fill=red!80!black,draw=red!80!black] coordinates {
        (FLAT\,32,1.31) (FLAT\,64,1.35) (FLAT\,128,1.38) (FLAT\,256,1.39)
        (PQ\,1,0.37) (PQ\,8,0.50) (PQ\,32,0.48)
      };
      \addplot[solid,green!60!black,thick,forget plot] coordinates
        {(FLAT\,32,1) (PQ\,32,1)};
    \end{axis}
  \end{tikzpicture}
  \end{center}
  \vspace{-0.3em}
  {\footnotesize Red bars $>$1 $=$ AMD ahead (FLAT). Bars $<$1 $=$ PQ gap.
  Green line $=$ parity.}
\end{frame}
